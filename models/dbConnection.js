...
function connectDB(callback){
    ...
    connection.connect(function(err){
        ...
        let createTransaction = 'create table if not exists transaction(id int not null auto_increment, username varchar(30) not null, money int not null, rate float not null, period int not null, loan_type varchar(20) not null, loan_reason varchar(250) not null, contract_addr varchar(50) not null, status int not null default 1, primary key(id)) DEFAULT CHARSET=utf8';        
        ...
        let createInvest = 'create table if not exists invest(id int not null auto_increment, investigator varchar(30) not null, loaner varchar(30) not null, money int not null, invest_money int not null, rate float not null, period int not null, loan_type varchar(20) not null, loan_reason varchar(250) not null, contract_addr varchar(50) not null, status int not null default 1, primary key(id)) DEFAULT CHARSET=utf8';        
